...
const GoogleLogo = () => (
  <svg viewBox="0 0 74 24" width="74" height="24">
    ...
    <path fill="#EA4335" d="M40.15 6.19c-3.21 0-5.83 2.44-5.83 5.81 0 3.34 2.62 5.81 5.83 5.81s5.83-2.46 5.83-5.81c0-3.37-2.62-5.81-5.83-5.81zm0 9.33c-1.76 0-3.28-1.45-3.28-3.52 0-2.09 1.52-3.52 3.28-3.52s3.28 1.43 3.28 3.52c0 2.07-1.52 3.52-3.28 3.52z"/>
  </svg>
);
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-[450px]">
          {/* Card */}
          <div className="border border-[#dadce0] rounded-lg p-10 sm:p-12 shadow-sm">
            {/* Google Logo */}
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 h-12 px-6 border border-[#dadce0] rounded-md text-[#3c4043] text-sm font-medium hover:bg-[#f8f9fa] hover:border-[#d2e3fc] hover:text-[#1967d2] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <span className="flex items-center gap-2">
                  <span className="h-5 w-5 border-2 border-[#dadce0] border-t-[#1a73e8] rounded-full animate-spin" />
                  Signing in...
                </span>
              ) : (
                <>
      ...
      <footer className="py-4 px-6 border-t border-[#dadce0] bg-[#f8f9fa]">
        <div className="max-w-[450px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-[#5f6368]">
